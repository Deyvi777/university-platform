...
import { updateSettingsAction } from "@/app/dashboard/configuracion/actions";
import {
  settingsFormSchema,
  toSettingsFormValues,
  toSettingsPayload,
  type SettingsFormValues,
} from "@/app/dashboard/configuracion/settings-schema";
...
const FIELDS: {
  ...
  },
  {
    key: "whatsapp",
    label: "WhatsApp",
    placeholder: "https://wa.me/59170000000",
    color: "#25D366",
...
export function SettingsForm({ settings }: { settings?: AdminSettings }) {
  ...
  async function onSubmit(values: SettingsFormValues) {
    const result = await updateSettingsAction(toSettingsPayload(values));
    if (result.ok) {
  ...
  return (
    ...
    >
      ...
      <p className="text-xs text-muted-foreground">
        Deja un campo vacío para ocultar su icono en el footer de la landing.
      </p>
