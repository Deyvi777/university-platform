        ...
        <div className="grid gap-12 lg:grid-cols-[1.5fr_1fr_1fr]">
          ...
          <div className="max-w-sm">
            ...
            <p className="mt-5 text-sm leading-6 text-slate-400">
              Escuela multidisciplinaria de postgrado. Maestrías y diplomados con
              docentes expertos y certificación con validez nacional.
            </p>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {socials.map((social) => (
                  <a
                    ...
                    className="group flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5 text-slate-300 transition-all duration-300 hover:-translate-y-0.5 hover:border-amber-400/50 hover:bg-amber-400/10 hover:text-amber-300"
                  >
                    <svg
