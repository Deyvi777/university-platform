...
| `activityFileUrl`         | `String?`           | **Tarea/Proyecto**: ruta `/files/materials/...` de un PDF o Word opcional con instrucciones o material de apoyo                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `activityFileName`        | `String?`           | **Tarea/Proyecto**: nombre original visible del documento adjunto                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
